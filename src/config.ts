...
export const themeConfig: ThemeConfig = {
  ...
  color: {
    ...
    semantic: {
      note: {
        light: 'oklch(48.8% 0.243 264.376 / 0.8)',
        dark: 'oklch(70.7% 0.165 254.624 / 0.8)',
      },
      tip: {
        light: 'oklch(50.8% 0.118 165.612 / 0.8)',
        dark: 'oklch(76.5% 0.177 163.223 / 0.8)',
      },
      important: {
        light: 'oklch(49.6% 0.265 301.924 / 0.8)',
        dark: 'oklch(71.4% 0.203 305.504 / 0.8)',
      },
      warning: {
        light: 'oklch(55.5% 0.163 48.998 / 0.8)',
        dark: 'oklch(82.8% 0.189 84.429 / 0.8)',
      },
      caution: {
        light: 'oklch(50.5% 0.213 27.518 / 0.8)',
        dark: 'oklch(70.4% 0.191 22.216 / 0.8)',
      },
    },
  },
  // 颜色设置 >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> 结束
